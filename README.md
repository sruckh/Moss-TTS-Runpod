...
| `MAX_REFERENCE_AUDIO_SECONDS` | Maximum allowed duration for `reference_audio` to avoid preprocessing OOM | `20` |
| `MAX_PREFIX_AUDIO_SECONDS` | Maximum allowed duration for `prefix_audio` to avoid preprocessing OOM | `120` |
